          ...
          >
            ...
            `"
              ...
              `"
                >
                  <img
                    v-if="item.picUrl&&!item.rightValue.code.includes('Attachment')"
          ...
          >
            ...
            <tr v-for="(row,index) in item.value" :key="index">
              ...
              >
                ...
                >
                  <span
                    v-for="(pic,picIndex) in row[col.rowSettings.bindSource.code]"
                    :key="picIndex"
                  >
                    <img
                      v-if="pic.url!==''"
    ...
    const htmlStr = `
        ...
        <html lang="en" xmlns="http://www.w3.org/1999/xhtml">
          <head>
            ...
            <title>晶奇打印-自定义模板打印</title>
            <style type="text/css">
             @page { margin: 0 ;size: ${this.setting.width}mm ${
      this.setting.height
    }mm;}
             @media print {
                 body {
