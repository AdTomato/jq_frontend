  ...
  <div class="data-rule-handler">
    <div class="step-wrap">
                ...
                <template slot="dataItem" slot-scope="text,record">
                  <div class="item-box">
                    <data-item-select
                      ...
                      :systemFilterCtl="{
                        code: ['id', 'sortKey', 'modifier', 'workflowInstanceId', 'ownerDeptQueryCode',`${triggerVal}.id`,`${triggerVal}.sortKey`,'parentId',`${triggerVal}.parentId`]
                      }"
                      :bizFilterCtl="{
                        type: [6, 7, 8, 9, 10],
                      }"
      ...
      <div class="handler-box" v-show="curStep === 1">
        ...
        <div class="handler-item" v-if="isMain">
          <div class="pull-left">
                  ...
                  <template slot="targetField" slot-scope="text,record">
                    <div class="item-box">
                      <data-item-select
                        ...
                        :systemFilterCtl="{
                          code: ['workflowInstanceId', 'sequenceNo', 'sequenceNo', 'modifier', 'ownerDeptQueryCode','sortKey',`${triggerVal}.sortKey`]
                        }"
                        :bizFilterCtl="{
                          type: [10, 8, 6, 7],
                        }"
                  ...
                  <template slot="currentField" slot-scope="text,record">
                    ...
                    <div class="item-box">
                      <data-item-select
                        ...
                        :systemFilterCtl="{
                          code: ['workflowInstanceId', 'sequenceNo', 'sequenceNo', 'name', 'ownerDeptQueryCode','sortKey',`${triggerVal}.sortKey`]
                        }"
                        :bizFilterCtl="{
                          type: [10, 8, 6, 7],
                        }"
                  ...
                  <template slot="targetField" slot-scope="text,record">
                    <div class="item-box">
                      <data-item-select
                        ...
                        :systemFilterCtl="{
                          code: ['modifier','sortKey',`${triggerVal}.sortKey`]
                        }"
                        :bizFilterCtl="{
                          type: [8, 6, 7],
                        }"
                  ...
                  <template slot="currentField" slot-scope="text,record">
                    ...
                    <div class="item-box">
                      <data-item-select
                        ...
                        v-show="record.value.val === 1"
                        :systemFilterCtl="{
                          code: ['ownerDeptQueryCode', 'workflowInstanceId', 'modifier','sortKey',`${triggerVal}.sortKey`]
                        }"
                        :bizFilterCtl="{
                          type: [8, 6, 7],
                        }"
