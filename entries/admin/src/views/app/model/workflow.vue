  ...
  <div class="workflow">
    <div class="workflow-head" @click="closeContextmenu">
      <div class="workflow-head-l">
        ...
        <span class="del-btn workflow-version"><i @click="openDelConfirm" class="icon aufontAll h-icon-all-delete-o"></i></span>
      </div>
...
export default class Workflow extends Vue {
  ...
  setWorkflowDataForAjax() {
    ...
    _activities.forEach((item: any) => {
      ...
      // 20190705 title同上
      // 20200114 子流程添加消息通知
      if (item.activityType === 'PARTICIPANT' || item.activityType === 'SUB_INSTANCE') {
