...
router.beforeEach((to, from, next) => {
  ...
  if (to.name &&
    ['appitem', 'datamodel', 'form-design', 'list-design', 'workflowDesign', 'report-design', 'dispatcher'].includes(to.name)) {
    document.title = document.title || '加载中...';
  } else {
    document.title = to.meta.title || '晶奇-admin';
  }
