...
<template>
  <div class="query-form" :class="{ collapsed : collapsed, showmore: showMore, showall: showAll}">
    ...
    <div class="query-form-right">
      ...
      <a-button @click="resetFilters" v-if="fields && fields.length">{{ $t('cloudpivot.list.pc.Reset') }}</a-button>
  ...
  toFormControl(field: any) {
    ...
    switch (type) {
      ...
      case renderer.FormControlType.RelevanceForm:
        ...
        options.selectMode = field.choiceType === 2 ? renderer.RelevanceFormSelectMode.Popup : renderer.RelevanceFormSelectMode.Dropdown;
        break;
